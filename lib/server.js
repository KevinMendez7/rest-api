    ...
    req.on('end', () => {
        ...
        try {
            ...
            chosenHandler(data, (statusCode, payload, contentType) => {
                server.processReponse(res, method, trimmedPath, statusCode, payload, contentType)
                
            })                    
        } catch(e) {
            debug(e)
            server.processReponse(res, method, trimmedPath, 500, { error : 'An unexpected error has ocurred'}, 'json')
        }
