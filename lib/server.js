...
server.init = () => {
    ...
    server.httpServer.listen(httpPort, () => console.log(`listening on port ${httpPort} and ${envName} mode`))

    // Start the https server
    server.httpsServer.listen(httpsPort, () => console.log(`listening on port ${httpsPort} and ${envName} mode`))
}
